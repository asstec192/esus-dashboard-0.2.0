...
import { useFormChangeOtherUserPassword } from "../hooks/useFormChangeOtherUserPassword";

export const AdminFormChangeOtherUserPassword = () => {
  const {
    form,
    mutation: { isError, error, isSuccess, data },
    onSubmit,
  } = useFormChangeOtherUserPassword();
